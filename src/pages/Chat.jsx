    ...
    <>
      {
        activeChat ?
          ...
          <img
            ...
            style={{ width: '40px', height: '40px', borderRadius: '15px', position: 'absolute', top: '3px', right: '100px' }}
          ...
          />
                ...
                {isImageClicked && (
        <img
          src="https://res.cloudinary.com/dedg75ktl/image/upload/v1701720890/WhatsApp_Image_2023-12-05_at_01.44.08_dab6e62f_nyvll3.jpg"
          alt="Second Image Description"
          style={{ width: '250px', height: '250px', borderRadius: '15px', position: 'absolute', top: '50px', right: '100px' }}
        />
      )}
              </div>
              <div>
